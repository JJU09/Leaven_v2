...
import { StorePoliciesForm } from '@/features/store/components/store-policies-form'
    ...
    return (
      <div className="flex flex-col gap-6 h-[calc(100vh-4rem)]">
        <div className="flex items-center justify-between shrink-0">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">운영 정책 설정</h1>
            <p className="text-muted-foreground">
              매장의 기본 급여, 정산 및 휴가 정책을 관리합니다.
            </p>
          </div>
        </div>
          ...
          <CardContent className="flex flex-col items-center justify-center gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground max-w-sm">
                운영 정책 설정은 점주(Owner)만 접근할 수 있습니다. 
    ...
    <div className="pb-10 pt-2 max-w-5xl mx-auto">
      <div className="mb-8 border-b pb-6">
        ...
        <p className="text-muted-foreground mt-1">
          우리 매장의 급여 정산 기간과 휴가 기준 등 운영에 필요한 기본 정책을 설정합니다.
        </p>
      </div>

      <div className="min-w-0">
        <StorePoliciesForm initialData={store} />
      </div>
    </div>
  )
}
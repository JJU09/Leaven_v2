    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[480px] p-0 gap-0 overflow-hidden">
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <div className="flex gap-1.5 mb-1">
              <Button 
                variant="outline"
                size="sm"
                className="px-2.5 py-1 text-[11px] h-auto font-medium rounded-md hover:bg-destructive/5 hover:text-destructive hover:border-destructive/30" 
        ...
        <div className="px-5 py-4 border-t border-black/10 bg-[#fbfbfb] flex justify-end gap-2">
          ...
          <Button 
            variant="destructive"
            className="px-5 py-2 text-[12px] h-auto font-medium rounded-md shadow-sm flex items-center gap-1.5"
